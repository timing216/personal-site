...
<body>
  ...
  <main id="contact_us">
    <h1 id="thanks-for-contact" style="text-align: center;">Thanks for registering!</h1>
    <h2 id="will-get-back" style="text-align: center;">You will be receiving our newsletter soon!</h2>
  </main>
  <footer>
